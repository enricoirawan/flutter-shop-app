...
class GetCacheUserAddressStatusUseCase extends UseCase<bool, NoParams> {
  final AddressRepository addressRepository;

  GetCacheUserAddressStatusUseCase({required this.addressRepository});

  @override
  Future<Either<Failure, bool>> call(NoParams params) {
    return addressRepository.getCacheUserAddressStatus();
  }
}
